...
- [x] 1. Domain layer: EmailVerificationToken entity and User modification
  - [x] 1.1 Create the EmailVerificationToken domain entity
  ...
  - [x] 1.2 Add EmailVerified flag to User entity
...
- [x] 2. Infrastructure layer: EF Core configuration and migration
  - [x] 2.1 Add EF Core configuration for EmailVerificationToken
  ...
  - [x] 2.2 Create EF Core migration
...
- [x] 3. Application layer: VerifyEmailCommand
  - [x] 3.1 Implement VerifyEmailCommand and handler
  ...
  - [x] 3.2 Add FluentValidation validator for VerifyEmailCommand
...
- [x] 4. Application layer: ResendVerificationCommand
  - [x] 4.1 Implement ResendVerificationCommand and handler
...
- [x] 5. Application layer: Modify RegisterCommand
  - [x] 5.1 Modify RegisterCommandHandler to generate verification token and send email
...
- [x] 6. Checkpoint - Backend application layer complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. API layer: AuthController endpoints
  - [x] 7.1 Add verify-email endpoint to AuthController
  ...
  - [x] 7.2 Add resend-verification endpoint to AuthController
  ...
  - [x] 7.3 Modify MeDto to include emailVerified field
...
- [x] 8. Frontend: API client and types
  - [x] 8.1 Add verifyEmail and resendVerification to the API client
...
- [x] 9. Frontend: Verify email page
  - [x] 9.1 Create the verify-email page
  ...
  - [x] 9.2 Add i18n strings for verify-email page
...
- [x] 10. Frontend: Verification banner
  - [x] 10.1 Create VerificationBanner component
  ...
  - [x] 10.2 Integrate VerificationBanner into AppShell
  ...
  - [x] 10.3 Add i18n strings for verification banner
