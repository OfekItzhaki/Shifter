...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "font-src 'self'",
      "connect-src 'self' http://localhost:5000 https://api.jobuler.app ws://localhost:3000 wss: https://*.sentry.io https://*.ingest.sentry.io https://*.posthog.com https://us.i.posthog.com",
      "worker-src 'self'",
