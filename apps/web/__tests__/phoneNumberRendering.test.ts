...
test("non-null phone number is rendered as-is", () => {
  const members: GroupMemberDto[] = [
    { personId: "1", fullName: "Alice", displayName: null, isOwner: false, phoneNumber: "050-1234567", invitationStatus: "pending", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
    { personId: "2", fullName: "Bob", displayName: "Bob", isOwner: false, phoneNumber: "+972501234567", invitationStatus: "accepted", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
    { personId: "3", fullName: "Carol", displayName: null, isOwner: true, phoneNumber: "03-9876543", invitationStatus: "accepted", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
  ];
...
test("null phone number renders as empty string (not 'null')", () => {
  const members: GroupMemberDto[] = [
    { personId: "1", fullName: "Alice", displayName: null, isOwner: false, phoneNumber: null, invitationStatus: "pending", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
    { personId: "2", fullName: "Bob", displayName: "Bob", isOwner: false, phoneNumber: null, invitationStatus: "pending", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
  ];
  for (const m of members) {
    const rendered = renderPhone(m);
...
test("mixed null and non-null phone numbers in same list", () => {
  const members: GroupMemberDto[] = [
    { personId: "1", fullName: "Alice", displayName: null, isOwner: false, phoneNumber: "050-1111111", invitationStatus: "accepted", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
    { personId: "2", fullName: "Bob", displayName: null, isOwner: false, phoneNumber: null, invitationStatus: "pending", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
    { personId: "3", fullName: "Carol", displayName: null, isOwner: false, phoneNumber: "050-2222222", invitationStatus: "accepted", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
    { personId: "4", fullName: "Dan", displayName: null, isOwner: false, phoneNumber: null, invitationStatus: "pending", profileImageUrl: null, birthday: null, linkedUserId: null, roleId: null, roleName: null, email: null },
  ];
...
test("100 random members — none render 'null' or 'undefined'", () => {
  ...
  for (let i = 0; i < 100; i++) {
    ...
    const m: GroupMemberDto = {
      ...
      roleId: null, roleName: null, email: null
    };
    const rendered = renderPhone(m);
