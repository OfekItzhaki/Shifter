  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Is my data secure?", a: "Absolutely. All data is encrypted, passwords are hashed with BCrypt, and communication uses HTTPS. Full isolation between groups. You can also enable biometric login (fingerprint/face) for extra security." },
        ...
        { q: "What if someone can't make their shift?", a: "The admin can mark 'can't make it' with a reason (vacation, sick, personal) and re-run the algorithm - it automatically finds a replacement." },
  ...
  he: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "האם המידע שלי מאובטח?", a: "בהחלט. כל המידע מוצפן, סיסמאות מאובטחות ב-BCrypt, והתקשורת מוצפנת ב-HTTPS. יש בידוד מלא בין קבוצות. ניתן גם להפעיל כניסה ביומטרית (טביעת אצבע/זיהוי פנים) לאבטחה נוספת." },
        { q: "אפשר לראות את הסידור בלי אינטרנט?", a: "כן! האפליקציה שומרת את הסידור האחרון במכשיר. גם בלי קליטה תוכל לראות את המשמרות שלך." },
        { q: "מה קורה אם מישהו לא יכול להגיע?", a: "המנהל יכול לסמן 'לא יכול להגיע' עם סיבה (חופשה, מחלה, אישי) ולהפעיל את האלגוריתם מחדש - הוא ימצא מחליף אוטומטית." },
  ...
  ru: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Мои данные в безопасности?", a: "Абсолютно. Все данные зашифрованы, пароли хешируются BCrypt, связь через HTTPS. Также можно включить биометрический вход (отпечаток/лицо)." },
        { q: "Можно смотреть расписание офлайн?", a: "Да! Приложение сохраняет последнее расписание на устройстве." },
        { q: "Что если кто-то не может выйти на смену?", a: "Админ отмечает 'не может' с причиной (отпуск, болезнь, личное) и перезапускает алгоритм - замена находится автоматически." },
