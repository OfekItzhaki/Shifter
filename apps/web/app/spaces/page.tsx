  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -start-40 w-96 h-96 bg-sky-100 rounded-full opacity-40 blur-3xl" />
      ...
      <div className="relative w-full max-w-md space-y-6">
          ...
          <div className="space-y-2">
            {spaces.map(space => (
              <button
                ...
                className="w-full text-start bg-white border border-slate-200 rounded-xl px-4 py-3.5 hover:border-sky-400 hover:bg-sky-50/50 hover:shadow-sm transition-all duration-150 group"
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-slate-100 group-hover:bg-sky-100 flex items-center justify-center shrink-0 transition-colors">
                    <svg className="w-4 h-4 text-slate-500 group-hover:text-sky-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <svg className="w-4 h-4 text-slate-300 group-hover:text-sky-400 ms-auto shrink-0 transition-colors rtl:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {!showCreate ? (
          <button
            ...
            className="w-full flex items-center justify-center gap-2 text-sm text-sky-600 hover:text-sky-700 font-medium py-2 transition-colors"
          >
          ...
          <form onSubmit={handleCreate} className="bg-white border border-slate-200 rounded-2xl p-5 space-y-4 shadow-sm">
            ...
            <input
              ...
              className="w-full border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-shadow"
              autoFocus
            />
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 bg-sky-500 hover:bg-sky-600 text-white text-sm py-2.5 rounded-xl font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
