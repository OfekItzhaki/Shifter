            ...
            {spaces.map(space => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <svg className="w-4 h-4 text-slate-300 group-hover:text-sky-400 ms-auto shrink-0 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
