          ...
          {step === "instructions" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button
                ...
                style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "#0ea5e9", background: "none", border: "1px solid #bae6fd", borderRadius: 8, padding: "7px 14px", cursor: "pointer", width: "fit-content" }}
              >
