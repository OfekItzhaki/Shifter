...
public class OrganizationSelfServiceDefaultsConfiguration : IEntityTypeConfiguration<OrganizationSelfServiceDefaults>
{
    public void Configure(EntityTypeBuilder<OrganizationSelfServiceDefaults> builder)
    {
        builder.ToTable("organization_self_service_defaults");
