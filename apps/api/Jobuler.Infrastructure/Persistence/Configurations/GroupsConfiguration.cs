...
{
    internal static SchedulingMode ParseSchedulingMode(string? value)
    {
        return value?.Trim().ToLowerInvariant() switch
        {
            "auto_generated" => SchedulingMode.AutoGenerated,
            "autogenerated" => SchedulingMode.AutoGenerated,
            "self_service" => SchedulingMode.SelfService,
            "selfservice" => SchedulingMode.SelfService,
            _ => Enum.Parse<SchedulingMode>(value ?? nameof(SchedulingMode.AutoGenerated), true)
        };
    }
    ...
    public void Configure(EntityTypeBuilder<Group> builder)
    {
        ...
        builder.Property(g => g.SchedulingMode).HasColumnName("scheduling_mode")
            .HasConversion(v => v.ToString(), v => ParseSchedulingMode(v))
            .HasDefaultValue(SchedulingMode.AutoGenerated);
