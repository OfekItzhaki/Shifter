...
public record GroupDto(Guid Id, Guid? GroupTypeId, string? GroupTypeName, string Name, string? Description, bool IsActive, int MemberCount, int SolverHorizonDays, Guid? OwnerPersonId, DateTime? SolverStartDateTime = null, bool AutoPublish = false, bool IsClosedBase = false, int MinRestBetweenShiftsHours = 8, string TemplateType = "Custom", bool AllowMembersViewHistory = true, bool AllowMembersViewStats = false, int ManagementTimeoutMinutes = 15, Guid? ParentGroupId = null, string SchedulingMode = "AutoGenerated");
