...
public class GroupsController : ControllerBase
{
    ...
    {
        await _permissions.RequirePermissionAsync(CurrentUserId, spaceId, Permissions.PeopleManage, ct);
        await _mediator.Send(new UpdateGroupSettingsCommand(spaceId, groupId, req.SolverHorizonDays, req.SolverStartDateTime, req.AutoPublish, req.MinRestBetweenShiftsHours, req.AllowMembersViewHistory, req.AllowMembersViewStats), ct);
        return NoContent();
    }
...
public record UpdateGroupSettingsRequest(int SolverHorizonDays, DateTime? SolverStartDateTime = null, bool? AutoPublish = null, int? MinRestBetweenShiftsHours = null, bool? AllowMembersViewHistory = null, bool? AllowMembersViewStats = null);
