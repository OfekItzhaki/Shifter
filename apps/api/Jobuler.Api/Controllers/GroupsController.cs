...
public class GroupsController : ControllerBase
{
    ...
    {
        await _permissions.RequirePermissionAsync(CurrentUserId, spaceId, Permissions.PeopleManage, ct);
        await _mediator.Send(new UpdateGroupSettingsCommand(spaceId, groupId, req.SolverHorizonDays, req.SolverStartDateTime, req.AutoPublish, req.MinRestBetweenShiftsHours, req.AllowMembersViewHistory, req.AllowMembersViewStats, req.ManagementTimeoutMinutes), ct);
        return NoContent();
    }
